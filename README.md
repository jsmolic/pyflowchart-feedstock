...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyflowchart-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyflowchart-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyflowchart
# for installing globally
pixi global install pyflowchart
```
...
It is possible to list all of the versions of `pyflowchart` available on your platform:
...
```
pixi search pyflowchart --channel conda-forge
```
